                        ...
                        <div class="heading-main-box">
                            <div class="search-box">
                                ...
                                <form action="search" id="search-form">
                                    ...
                                    <button class="submit-btn input-box" id="search-div" name="button" value="" onclick="setButtonSubmitSearchForm(this)">
                        <span class="fa fa-search"></span> Tìm kiếm
                    </button>
                                    <button type="submit" class="submit-btn input-box" name="button" value="advanced" onclick="setButtonSubmitSearchForm(this)">
